...
const Menu = () => {
    return (
        <div className="bg-black hover:bg-slate-950 text-slate-100 hover:text-white flex items-center justify-center gap-x-1 py-1 h-10 top-20 sticky">
          <Link href={"/"} className="h-9 rounded-full text-center text-xs sm:text-sm hover:text-white flex items-center justify-center gap-x-1 sm:px-3 py-1 border-[2px] border-gray-400 hover:border-orange-600 duration-200 relative">
              Home
          </Link>
